...
export const DESTINATIONS: StaticDestination[] = [
  ...
  // Asie
  { iataCode: "TBS", cityName: "Tbilisi", countryName: "Georgia", countryCode: "GE", latitude: 41.6938, longitude: 44.8015, uniquenessScore: 0.9, tags: ["culture", "wine", "food"] },
  ...
  { iataCode: "SCL", cityName: "Santiago", countryName: "Chile", countryCode: "CL", latitude: -33.3927, longitude: -70.7854, uniquenessScore: 0.78, tags: ["wine", "mountains", "culture"] },
  ...
  // Europe Classique (score plus bas car plus connues)
...
export function estimateFlightDuration(distanceKm: number): number {
  ...
  // + temps de décollage/atterrissage (~30 min)
  const flightTimeHours = distanceKm / 800;
  return Math.round(flightTimeHours * 60 + 30);
}
